...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      h4('The ui.R and server.R files on GitHub'),
      p('For this application the ui.R and server.R files can be found on this GitHub repository:'),
      a("https://github.com/Teuton2015/Developing_Data_Products"),
